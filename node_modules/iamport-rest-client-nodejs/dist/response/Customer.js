...
class Customer extends Base_1.default {
    setAttributes(response) {
        const { customer_uid, card_name, card_code, card_number, card_issuer_code, card_publisher_code, card_issuer_name, card_publisher_name, customer_name, customer_tel, customer_email, customer_addr, customer_postcode, inserted, updated, } = response;
